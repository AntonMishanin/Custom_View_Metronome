...
public class MetronomeView extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        final float plateWidth = 900;//mPlateScaler.getPlateWidth();
    ...
    private void drawSwing(Canvas canvas) {
        ...
        final float plateWidth = 800;//mPlateScaler.getPlateWidth();
        final float plateHeight = 1200;//mPlateScaler.getPlateHeight();
        final float plateVisibleHeight = 1200;//mPlateScaler.getPlateVisibleHeight();
